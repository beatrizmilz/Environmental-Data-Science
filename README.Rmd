...
This is a repository to gather information about Environmental Data Science, such as: events, groups, books, papers, journals, courses, etc.

The idea is to have a place to find information about Environmental Data Science, and to share it with others.

Feel free to contribute by suggesting contents (e.g., [open a issue](https://github.com/beatrizmilz/Environmental-Data-Science/issues)) or by making a pull request to [add new content in this file](https://github.com/beatrizmilz/Environmental-Data-Science/blob/main/README.Rmd).
...
Contributions are welcome! Please, feel free to submit a pull request or open an issue to discuss a new resource.
